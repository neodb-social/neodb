...
# Cron jobs
# All cron constants are in seconds, when TTL set to -1 means forever keeping the job results
CRON_INTERVAL_REFRESH_MASTODON = 3600
CRON_TTL_REFRESH_MASTODON = 7200
# in hours
MASTODON_DATA_TTL = 24